...
return [
    ...
    */
    ...
    'exists' => ':attribute معتبر نمی باشد.',
    ...
    'password' => [
        ...
        'mixed' => ':attribute باید شامل حداقل یک حرف بزرگ و یک حرف کوچک انگلیسی باشد.',
        'numbers' => ':attribute باید شامل حداقل یک عدد باشد.',
        'symbols' => ':attribute باید شامل حداقل یک سمبل باشد.',
    ...
    'required_array_keys' => ':attribute باید دارای مقادیر :values باشد.',
    'required_if' => ':attribute هنگامی که :other :value می باشد لازم است.',
    ...
    */
    ...
    'values' => [
        ...
        'permissions' => [
            ...
            'JU' => 'پیوستن به اتحاد',
            'DM' => 'مدیریت سلسله',
            'PIUP' => 'شرکت در پروژه های اتحادی',
            'PITC' => 'شرکت در چالش ها',
            'PIC' => 'شرکت در مسابقات',
            'ESOO' => 'تاسیس فروشگاه یا دفتر',
            'COTB' => 'ساخت بنا',
        ],
        'asset' => [
            'psc' => 'psc',
    ...
    */
    ...
    'attributes' => [
        'ir_mobile' => 'شماره تلفن همراه',
        'phone' => 'شماره تلفن همراه',
        'time' => 'مدت زمان',
        'relationship' => 'نسبت خانوادگی',
        'user' => 'کاربر',
