...
<head>
    ...
    <!--<![endif]-->
    <title>پیشنهاد ارسالی جهت ورود به سلسله خانوادگی در متارنگ</title>
    <!--[if !mso]><!-->
    <!--<![endif]-->
    <style type="text/css">
        body{
                            ...
                            <div style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:4px solid #fd7e14; border-bottom:0px solid transparent; border-right:4px solid #fd7e14; padding-top:55px; padding-bottom:60px; padding-right: 0px; padding-left: 0px;direction: rtl;">
                                    ...
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.2;padding-top:10px;padding-right:50px;padding-bottom:10px;padding-left:50px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 14px;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 24px;">پیشنهادی برای اعضای خانواده خود جهت ورود به سلسله خانوادگی متارنگ ارسال کرده اید</span></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.2;padding-top:10px;padding-right:50px;padding-bottom:10px;padding-left:50px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 14px;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 24px;">مشخصات دریافت کننده<span> : </span></span></p>
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">شناسه شهروندی<span> : </span><a href="https://rgb.irpsc.com/citizen/{{ \Illuminate\Support\Str::upper($request->toUser->code) }}"style="color:#fd7e14">{{ \Illuminate\Support\Str::upper($request->toUser->code) }}</a></span></p><hr style="border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">نام<span> : </span>{{ $request->toUser->kyc->fname }}</span></p><hr style="border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">نام خانوادگی<span> : </span>{{ $request->toUser->kyc->lname }}</span></p><hr style="border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">نسبت<span> : </span>{{ getFamilyRelationship($request->relationship) }}</span></p><hr style="border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px;">سطح<span> : </span>{{ $request->toUser->level->slug ?? '0' }}</span></p><hr style="border-width:3px;border-color:#795E8B;">
                                        </div>
                                    </div>
                                    ...
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.5;padding-top:10px;padding-right:30px;padding-bottom:25px;padding-left:30px;">
                                        <div style="line-height: 1.5; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 18px;">
                                            <p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin: 0;"><em>جمع های خانوادگی در دنیای موازی جذابیت چشمگیری دارد</em></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <!--[if (!mso)&(!IE)]><!-->
                        ...
                        <div class="col num12" style="min-width: 320px; max-width: 650px; display: table-cell; vertical-align: top; width: 650px;">
                            <div style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                    <!--<![endif]-->
                                    <div align="center" class="img-container center autowidth" style="padding-right: 0px;padding-left: 0px;">
                                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" border="0" class="center autowidth" src="https://rgb.irpsc.com/images/emails/images-footer-sender-confirmation.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 650px; display: block;" width="650"/>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
