...
<head>
    ...
    <!--<![endif]-->
    <title>فضای VOD خود را در متارنگ قیمت گذاری کردید</title>
    <!--[if !mso]><!-->
    <!--<![endif]-->
    <style type="text/css">
        body{
                                ...
                                <div style="border-top:0px solid transparent; border-left:4px solid #fd7e14; border-bottom:0px solid transparent; border-right:4px solid #fd7e14; padding-top:55px; padding-bottom:60px; padding-right: 0px; padding-left: 0px;direction: rtl;">
                                    ...
                                    <div style="color:#fd7e14;font-family:iranyekan;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #fd7e14; font-family: iranyekan; mso-line-height-alt: 14px;">
                                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 17px; margin: 0;"><strong><span style="font-size: 40px;"> سلام </span><br><span style="font-size: 30px"><a href="https://rgb.irpsc.com/citizen/{{ \Illuminate\Support\Str::upper($feature->owner->code) }}"style="color:#fd7e14">{{ \Illuminate\Support\Str::upper($feature->owner->code) }}</a></span></strong></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.2;padding-top:10px;padding-right:50px;padding-bottom:10px;padding-left:50px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 14px;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 24px;">فضای VOD خود را در متارنگ قیمت گذاری کردید</span></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.2;padding-top:10px;padding-right:50px;padding-bottom:10px;padding-left:50px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 14px;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 24px;"><span>فضای VOD قیمت گذاری شده</span> : </span></p>
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px;">متراژ<span> : </span>{{ $feature->properties->stability }}</span></p><hr style="border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px;text-transform:uppercase">شناسه<span> : </span>{{ $feature->properties->id }}</span></p><hr style="border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">کاربری<span> : </span>{{ $feature->getApplicationTitle() }}</span></p><hr style="border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">تراکم<span> : </span>{{ $feature->properties->density }}</span></p><hr style="border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">مرزبندی مجازی با نقاط<span> : </span>{{ $feature->getCoordinates() }}</span></p><hr style="border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px;">آدرس <span> : </span>{{ $feature->properties->address }}</span></p><hr style="border-width:3px;border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 24px;"><span>قیمت ثبت شده</span>: </span></p>
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">IRR/ریال<span> : </span>{{ number_format($feature->latestSellRequest->price_irr) }}</span><br><span style="font-size: 18px">PSC/پی اس سی<span> : </span>{{ number_format($feature->latestSellRequest->price_psc) }}</span></p><hr style="border-color:#795E8B;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px;text-transform:uppercase">شناسه عملیات<span> : </span>---</span></p><hr style="border-color:#795E8B;">
                                        </div>
                                    </div>
                                    ...
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.5;padding-top:10px;padding-right:30px;padding-bottom:25px;padding-left:30px;">
                                        <div style="line-height: 1.5; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 18px;">
                                            <p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin: 0;"><em>افزایش تبادل در دنیای موازی چرخه ای نوین از اقتصاد کلان میباشد</em></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <!--[if (!mso)&(!IE)]><!-->
                            ...
                            <div style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:55px; padding-bottom:55px; padding-right: 30px; padding-left: 30px;">
                                    ...
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.5;padding-top:10px;padding-right:25px;padding-bottom:20px;padding-left:25px;">
                                        <div style="line-height: 1.5; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 18px;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 22px;"><span>ساعت ثبت : <span>{{ \Morilog\Jalali\Jalalian::forge($feature->latestSellRequest->created_at)->format('H:m:s') }}</span><br><span>تاریخ ثبت : </span><span>{{ \Morilog\Jalali\Jalalian::forge($feature->latestSellRequest->created_at)->format('Y/m/d') }}</span></span> </span></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <div align="center" class="button-container" style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://rgb.irpsc.com" style="height:45.75pt; width:225pt; v-text-anchor:middle;" arcsize="50%" strokeweight="1.5pt" strokecolor="#795E8B" fillcolor="#3d1554"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:iranyekan; font-size:18px"><![endif]--><a href="https://rgb.irpsc.com" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #3d1554; border-radius: 30px; -webkit-border-radius: 30px; -moz-border-radius: 30px; width: auto; width: auto; border-top: 2px solid #795E8B; border-right: 2px solid #795E8B; border-bottom: 2px solid #795E8B; border-left: 2px solid #795E8B; padding-top: 18px; padding-bottom: 18px; font-family: iranyekan; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:35px;padding-right:35px;font-size:18px;display:inline-block;"><span style="font-size: 16px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 19px;"><span data-mce-style="font-size: 18px; line-height: 21px;" style="font-size: 18px; line-height: 21px;">ورود به متارنگ</span></span></span></a>
                        ...
                        <div class="col num12" style="min-width: 320px; max-width: 650px; display: table-cell; vertical-align: top; width: 650px;">
                            <div style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                    <!--<![endif]-->
                                    <div align="center" class="img-container center autowidth" style="padding-right: 0px;padding-left: 0px;">
                                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" border="0" class="center autowidth" src="https://rgb.irpsc.com/images/emails/images-footer-sell-request.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 650px; display: block;" width="650"/>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
