...
<head>
    ...
    <!--<![endif]-->
    <title>فضای VOD خریداری شده در متارنگ ثبت شد</title>
    <!--[if !mso]><!-->
    <!--<![endif]-->
    <style type="text/css">
        body{
                            ...
                            <div style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:4px solid #fd7e14; border-bottom:0px solid transparent; border-right:4px solid #fd7e14; padding-top:55px; padding-bottom:60px; padding-right: 0px; padding-left: 0px;direction: rtl;">
                                    ...
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.2;padding-top:10px;padding-right:50px;padding-bottom:10px;padding-left:50px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 14px;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 24px;">تبریک میگم فضای<span> VOD </span>خریداری شده در متارنگ ثبت شد</span></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.2;padding-top:10px;padding-right:50px;padding-bottom:10px;padding-left:50px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 14px;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 24px;">مشخصات <span> VOD خریداری شده</span> : </span></p>
                                            ...
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 24px;">مشخصات <span> فروشنده </span>: </span></p>
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">شناسه شهروندی<span> : </span><a href="https://rgb.irpsc.com/citizen/{{ \Illuminate\Support\Str::upper($feature->latestTraded->seller->code) }}"style="color:#fd7e14">{{ \Illuminate\Support\Str::upper($feature->latestTraded->seller->code) }}</a></span></p><hr style="border-color:#795E8B;">
                                            ...
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 18px">شناسه عملیات<span> : </span>---</span></p><hr style="border-color:#795E8B;">
                                        </div>
                                    </div>
                            ...
                            <div style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:55px; padding-bottom:55px; padding-right: 30px; padding-left: 30px;">
                                    ...
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.5;padding-top:10px;padding-right:25px;padding-bottom:20px;padding-left:25px;">
                                        <div style="line-height: 1.5; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 18px;">
                                            <p style="font-size: 18px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 27px; margin: 0;"><span style="font-size: 28px;">من VOD را خریداری نکرده ام<span style="font-size: 26px;color: red;"><br><br><strong>قفل واریزی صورت گرفته</strong></span><br><br><span style="font-size: 26px;color: white;background-color: red"><strong>با کلیک بر روی دکمه "قفل واریزی" VOD خریداری شده قابلیت معامله نخواهد داشت و مبلغ تراکنش صورت گرفته در حساب فروشنده نیز به حالت قفل درخواهد آمد تا بررسی توسط تیم امنیتی متارنگ صورت گیرد ، لازم به ذکر است اگر زمان بازکردن امنیت حساب کاربری احراز با خط شما صورت گرفته شده باشد خسارت وارده به فروشنده VOD و نیز هزینه بررسی عملیات امنیتی از دارایی شما کسر خواهد شد .</strong></span></p>
                        ...
                        <div class="col num12" style="min-width: 320px; max-width: 650px; display: table-cell; vertical-align: top; width: 650px;">
                            <div style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                    <!--<![endif]-->
                                    <div align="center" class="img-container center autowidth" style="padding-right: 0px;padding-left: 0px;">
                                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" border="0" class="center autowidth" src="https://rgb.irpsc.com/images/emails/images-footer-vod-purchased.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 650px; display: block;" width="650"/>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
