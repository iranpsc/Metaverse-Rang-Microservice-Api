...
<head>
    ...
    <!--<![endif]-->
    <title>احراز ایمیل برای ثبت نام نهایی در متاورس رنگ</title>
    <!--[if !mso]><!-->
    <!--<![endif]-->
    <style type="text/css">
        body{
                                ...
                                <div style="border-top:0px solid transparent; border-left:4px solid #fd7e14; border-bottom:0px solid transparent; border-right:4px solid #fd7e14; padding-top:55px; padding-bottom:60px; padding-right: 0px; padding-left: 0px;direction: rtl;">
                                    ...
                                    <div style="color:#fd7e14;font-family:iranyekan;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #fd7e14; font-family: iranyekan; mso-line-height-alt: 14px;">
                                            <p style="font-size: 14px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 17px; margin: 0;"><strong><span style="font-size: 40px;"> سلام </span><br><span style="font-size: 30px;text-transform:uppercase"> {{ $email }} </span></strong></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.2;padding-top:10px;padding-right:50px;padding-bottom:10px;padding-left:50px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 14px;">
                                            <p style="font-size: 28px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 28px;"> دنیای موازی متارنگ مشتاق دیدار شماست ، برای تایید ایمیل و ورود به متارنگ روی گزینه زیر کلیک کن </span></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <div align="center" class="button-container" style="padding-top:12px;padding-right:10px;padding-bottom:12px;padding-left:10px;">
                                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 12px; padding-right: 10px; padding-bottom: 12px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $url }}" style="height:42pt; width:233.25pt; v-text-anchor:middle;" arcsize="54%" stroke="false" fillcolor="#fbd711"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#000000; font-family:iranyekan; font-size:18px"><![endif]--><a href="{{ $url }}" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #000000; background-color: #fd7e14; border-radius: 30px; -webkit-border-radius: 30px; -moz-border-radius: 30px; width: auto; width: auto; border-top: 1px solid #fd7e14; border-right: 1px solid #fbd711; border-bottom: 1px solid #fbd711; border-left: 1px solid #fbd711; padding-top: 10px; padding-bottom: 10px; font-family: iranyekan; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:45px;padding-right:45px;font-size:18px;display:inline-block;"><span style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span data-mce-style="font-size: 18px; line-height: 36px;" style="font-size: 18px;color : white; line-height: 36px;"><strong>تایید ایمیل</strong></span></span></span></a>
                                        <!--[if mso]></center></v:textbox></v:roundrect></td></tr></table><![endif]-->
                                    </div>
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.2;padding-top:10px;padding-right:50px;padding-bottom:10px;padding-left:50px;">
                                        <div style="line-height: 1.2; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 14px;">
                                            <p style="font-size: 20px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 20px;">لینک تغییر گذرواژه</span></p>
                                        </div>
                                    </div>
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.5;padding-top:10px;padding-right:25px;padding-bottom:10px;padding-left:25px;">
                                        <div style="line-height: 1.5; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 18px;">
                                            <p style="font-size: 16px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 20px;"><a href="{{ $url }}" style="text-decoration: underline; color: #ffffff;"> <br><b>{{ $url }}</b> </a></span></p>
                                        </div>
                                    </div>
                                    ...
                                    <div style="color:#ffffff;font-family:iranyekan;line-height:1.5;padding-top:10px;padding-right:30px;padding-bottom:25px;padding-left:30px;">
                                        <div style="line-height: 1.5; font-size: 12px; color: #ffffff; font-family: iranyekan; mso-line-height-alt: 18px;">
                                            <p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: center; mso-line-height-alt: 21px; margin: 0;"><em>میدونستی در آینده ای نچندان دور بخشی از زندگی بشر در دنیای موازی سپری میشه ؟</em></p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    <!--[if (!mso)&(!IE)]><!-->
                        ...
                        <div class="col num12" style="min-width: 320px; max-width: 650px; display: table-cell; vertical-align: top; width: 650px;">
                            <div style="width:100% !important;">
                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:0px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;">
                                    <!--<![endif]-->
                                    <div align="center" class="img-container center autowidth" style="padding-right: 0px;padding-left: 0px;">
                                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" border="0" class="center autowidth" src="https://rgb.irpsc.com/images/emails/images-footer.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 650px; display: block;" width="650"/>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
